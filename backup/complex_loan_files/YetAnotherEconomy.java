...
public final class YetAnotherEconomy extends YAECoreBase {
    ...
    private void registerCoreServices() {
        ...
        // Register CreditService - Dynamic credit scoring system
        com.yae.api.credit.CreditService creditService = new com.yae.api.credit.CreditService(this);
        registerService(creditService);
        debug("Registered CreditService");
        
        // Register LoanApplicationService - 5-step loan application workflow
        com.yae.api.loan.LoanApplicationService loanService = new com.yae.api.loan.LoanApplicationService(this);
        registerService(loanService);
        debug("Registered LoanApplicationService");
        
        // Register RepaymentService - Auto and manual payment processing
        com.yae.api.loan.RepaymentService repaymentService = new com.yae.api.loan.RepaymentService(this);
        registerService(repaymentService);
        debug("Registered RepaymentService");
        
        // Register OverdueProcessingService - Delinquent loan management
        com.yae.api.loan.OverdueProcessingService overdueService = new com.yae.api.loan.OverdueProcessingService(this);
        registerService(overdueService);
        debug("Registered OverdueProcessingService");
        ...
        // Register ReceiptCommand - now auto-registered by constructor
        com.yae.api.shop.ReceiptCommand receiptCommand = new com.yae.api.shop.ReceiptCommand(this);
        debug("ReceiptCommand created and auto-registered");
